...
const UpdateInvoiceModal = ({ handleCloseUpdateInvoiceModal, invoice }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    formData.append("maintenanceRequestId", data.maintenanceRequestId);
    ...
    try {
      const response = await axios.put(
        `${baseUrl}/update-invoice/${invoice.invoiceId}`,
        formData
      );
    ...
    <div className="w-full h-screen absolute top-0 left-0 bg-black/50 flex items-center justify-center">
      <div className="w-[800px] max-w-full h-[85%] overflow-y-auto mx-auto bg-white p-8 rounded-lg shadow-xl">
        <div className="w-full flex justify-between items-center mb-4">
          ...
          <button
            onClick={() => handleCloseUpdateInvoiceModal(false)}
